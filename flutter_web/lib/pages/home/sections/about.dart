...
class _AboutSection extends StatefulWidget {
  const _AboutSection({this.onTapSeeWhatIDo, required this.onBuildWidget});
...
class _AboutSectionState extends State<_AboutSection> {
  bool _onHoverHarvardCs50x = false;
        ...
        Text.rich(
          TextSpan(
            children: [
              WidgetSpan(
                child: InkWell(
                  onTap: () => launchUrl(C.url.harvardCs50xAddress),
                  onHover: (value) => setState(() {
                    _onHoverHarvardCs50x = value;
                  }),
                  child: Container(
                    decoration: BoxDecoration(
                      color: _onHoverHarvardCs50x
                          ? Colors.transparent
                          : Colors.white,
                    ),
          ...
          style: Theme.of(
            context,
          ).textTheme.titleMedium?.copyWith(color: Colors.white, height: 2),
        ),
