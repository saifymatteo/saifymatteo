...
import 'package:flutter_web/ui/pages/about/page.dart' as _i2;
import 'package:flutter_web/ui/pages/home/page.dart' as _i3;
import 'package:flutter_web/ui/shell.dart' as _i1;
  ...
  final Map<String, _i4.PageFactory> pagesMap = {
    PortfolioShellRoute.name: (routeData) {
      return _i4.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i1.PortfolioShellScreen(),
      );
    },
    PortfolioAboutRoute.name: (routeData) {
      return _i4.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i2.PortfolioAboutScreen(),
      );
    },
    PortfolioHomeRoute.name: (routeData) {
      return _i4.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.PortfolioHomeScreen(),
      );
    },
  };
}
