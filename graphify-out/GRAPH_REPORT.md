# Graph Report - saifymatteo  (2026-08-20)

## Corpus Check
- 87 files · ~505,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 658 nodes · 815 edges · 56 communities (40 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea840cac`
...
Cohesion: 0.06
Nodes (26): fadeUp, HomeHero(), ProjectCard(), TechStack(), AppProjectsPage(), metadata, CaseStudyBody(), CaseStudyHero() (+18 more)
...
Cohesion: 0.08
Nodes (19): dynamic, elsewhere, Footer(), links, MotionProvider(), AppNavigationBar(), AppConstants, Status (+11 more)
...
### Community 29 - "localization.dart"
Cohesion: 0.33
...
### Community 54 - "app_state.dart"
Cohesion: 0.40
Nodes (4): HomeSections, _scrollContext, updateScrollContext, Map

## Knowledge Gaps
- **296 isolated node(s):** `Props`, `metadata`, `buttonVariants`, `dynamic`, `ResumeViewer` (+291 more)
...
- **Why does `_` connect `_` to `constants.dart`, `StatelessWidget`, `model.dart`, `package:flutter/material.dart`, `PortfolioModel`, `State`, `route.dart`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `devDependencies`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `Props`, `metadata`, `buttonVariants` to the rest of the system?**
